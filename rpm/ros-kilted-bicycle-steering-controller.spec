...
Name:           ros-kilted-bicycle-steering-controller
Version:        5.17.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS bicycle_steering_controller package
...
BuildRequires:  ros-kilted-steering-controllers-library
...
%description
Steering controller with bicycle kinematics. Rear fixed wheel is powering the
